...
tables_list=("account" "accountaccesstype" "accountbalance" "accountdormancystatus" "accounthistory" "accountsegment" "activitylogcategory" "activitylogtype" "addresstype" "award" "awardtype" "bnk_account" "bnk_customer" "bnk_customeraccount" "bnk_plastichistory" "bnk_product" "cardstatus" "communicationpreference" "communicationpreferencestatus" "contacttype" "country" "culture" "customer" "customeraccount" "customeraddress" "customerbalance" "customercontact" "customerprimaryaddress" "customersource" "enrollmentstatus" "gender" "mcclist" "mcctype" "order" "orderdetailtracking" "orderdetailtrackingstatus" "orderdetailtrackinghistory" "phonenumbertype" "point" "pointcategory" "pointtype" "province" "segment" "transactionreasoncode")
